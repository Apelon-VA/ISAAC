...
public class PerConceptLuceneSearchStrategy<T> extends AbstractLuceneSearchStrategy<T> implements SearchStrategyI<T> {
	public PerConceptLuceneSearchStrategy(SearchResultFactoryI<T> srf) {
		super(srf);
	}
	public PerConceptLuceneSearchStrategy(SearchResultFactoryI<T> srf, List<T> resultsList) {
	...
	public synchronized void search() {
		...
		try
		{
			...
			processResults(tempUserResults.values());
		}
		catch (Exception ex)
		{
