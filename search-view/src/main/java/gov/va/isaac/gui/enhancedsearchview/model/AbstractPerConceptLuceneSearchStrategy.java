...
public abstract class AbstractPerConceptLuceneSearchStrategy<T> extends AbstractLuceneSearchStrategy<T> implements SearchStrategyI<T> {
	public AbstractPerConceptLuceneSearchStrategy() {
		super();
	}
	public AbstractPerConceptLuceneSearchStrategy(List<T> resultsList) {
		super(resultsList);
	}
