...
/**
 * {@link UpdateableStringBinding}
 * 
 * No idea why StringBinding has these variations of these methods that are protected and final...
 ...
 */
public abstract class UpdateableListBinding<T> extends ListBinding<T>
{
	...
	/**
	 * @see javafx.beans.binding.StringBinding#onInvalidating()
	 */
	@Override
