...
/**
 * {@link LogicNegateRelationshipValue}
 * 
...
@PerLookup
public class LogicNegateRelationshipValue extends Operation
{
	private LogicNegateRelationshipValue()
	{
		//For HK2 to init
	}
	@Override
	...
	{
		return "Logic, Negate Relationship Value";
	}
	...
	{
		return new CustomTask<OperationResult>(LogicNegateRelationshipValue.this)
		{
			@Override
...
//				return ParentAddNew.this.getTitle() + " completed - modified 0 concepts";
				//TODO implement LogicNegateRelationshipValue
