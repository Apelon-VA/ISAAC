...
/**
 * Abstract base class for problems, which are clinical conditions that need to
 * be treated or managed.
 * 
 * Note that allergies are represented as a special type of conditions
 * represented by the AllergyOrIntolerance concept, whereas individual adverse
 * events are represented as adverse events.
 * 
 * <p>
 * Java class for ConditionBase complex type.
 * 
 * <p>
...
@XmlType(name = "ConditionBase", propOrder = {
    "affectedBodySite", "conditionCode", "conditionEffectiveTime",
    "diagnosticEventTime"
})
@XmlSeeAlso({
    AbstractDeniedCondition.class, AbstractCondition.class
})
public abstract class ConditionBase extends ClinicalStatement {
