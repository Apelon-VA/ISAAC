...
/**
 * Class that represents a generic Name-Value-Pair object where the name is
 * generally a token (a string without spaces), a semantic category that is
 * controlled by a terminology and a value which may be any type deriving from
 * ANY and/or defined by a template.
 * 
 * <p>
...
@XmlType(name = "NameValuePair", propOrder = {
    "name", "semanticCode", "value"
})
public class NameValuePair extends ExtendedVmrTypeBase {
   ...
   * 
   * @return possible object is {@link ExtendedVmrTypeBase }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link ExtendedVmrTypeBase }
   * 
   */
