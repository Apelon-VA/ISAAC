...
/**
 * A clinical proposal for dispensing an enteral feeding product.  That is, the product is to be dispensed but not administered to the patient.
 * 
 * <p>Java class for EnteralFeedingDispenseProposal complex type.
 * 
...
public class EnteralFeedingDispenseProposal
    extends SubstanceDispenseProposal
{
