...
/**
 * Documents the non-delivery of a substance. E.g., documents that an influenza
 * immunization was not given because the patient refused or had an adverse
...
public class UndeliveredSubstanceAdministration extends
