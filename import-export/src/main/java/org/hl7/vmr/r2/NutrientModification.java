...
/**
 * Nutrient modifications allows the post-coordination of diets in cases where
 * such post-coordination is required. Diets can vary greatly in how they are
 * represented in terminologies. The most common use case for Nutrient
 * modification is to represent a nutrient that can be either stated as a
 * quantity or a range
 * 
 * NutrientModification consists of the nutrient (e.g., Sodium) and the amount
 * in the diet (e.g., 20-30g). Note that nutrient is required and of type CD.
 * The 'quantity' attribute is also required and can express a range.
 * 
 * <p>
 * Java class for NutrientModification complex type.
 * 
 * <p>
...
public class NutrientModification extends ExtendedVmrTypeBase {
