...
/**
 * The abstract base class for an observation which represents a result (e.g., a
 * laboratory value), a clinical finding (e.g., sitting, tachypneic, rebound
 * tenderness), or an inferred finding such as one produced by a CDS system
 * (e.g., patient is in need of an HbA1c test).
 * 
 * <p>
 * Java class for ObservationBase complex type.
 * 
 * <p>
...
@XmlType(name = "ObservationBase", propOrder = {
    "observationFocus", "observationMethod", "targetBodySite",
    "interpretation", "observationEventTime", "status"
})
@XmlSeeAlso({
    ObservationResult.class, CompositeObservationResult.class
})
public abstract class ObservationBase extends ClinicalStatement {
   ...
   * for the interpretation property.
   * 
   * <p>
