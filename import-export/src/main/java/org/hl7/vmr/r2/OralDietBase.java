...
/**
 * Concept generally representing food and/or a nutritional supplement prepared
 * from food ingredients that is self-administered by a patient and consumed
 * orally. Note that nutritional supplements derived from a specific product
 * such as an Ensure shake or Metamucil should be represented using
 * SubstanceAdministration or SubstanceDispense-related classes.
 * 
 * <p>
 * Java class for OralDietBase complex type.
 * 
 * <p>
...
@XmlType(name = "OralDietBase", propOrder = {
    "dietType", "foodType", "nutrient", "texture", "frequency", "urgency",
    "reason", "prnReason", "isInEffect", "originationMode"
})
@XmlSeeAlso({
    OralDietOrder.class, OralDietProposal.class
})
public abstract class OralDietBase extends ClinicalStatement {
