...
/**
 * A clinical proposal for provision of a supply of a medication generally with
 * the intention that it is subsequently consumed by a patient (usually in
 * response to a prescription).
 * 
 * An proposal for a substance to be dispensed but not administered. (E.g.,,
 * �naloxone at bedside�).
 * 
 * <p>
 * Java class for SubstanceDispenseProposal complex type.
 * 
 * <p>
...
@XmlType(name = "SubstanceDispenseProposal", propOrder = {
    "dispenseType", "proposedDispenseTime", "dispenseQuantity",
    "numberOfFillsAllowed", "supplyDuration", "reason", "urgency",
    "validityPeriod", "proposalEventTime", "originationMode"
})
@XmlSeeAlso({
  EnteralFeedingDispenseProposal.class
})
public class SubstanceDispenseProposal extends SubstanceClinicalStatementBase {
