...
/**
 * This type may be used to represent documentation that is either free text or
 * richer in format (e.g., XML or HTML) where provenance is not relevant. The
 * type of the documentation is determined by a code that represents the type of
 * documentation ("e.g., a consult note, a provider instruction, a patient
 * instruction, etc...). It is intended to represent comment fields and notes
...
public class Documentation extends ExtendedVmrTypeBase {
