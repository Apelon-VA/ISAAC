...
/**
 * A clinical order for the administration of a substance. Describes the event of a patient being given a dose of a medication. This may be as simple as swallowing a tablet or it may be a long running infusion. 
 * 
 * Medication prescription represents both the dispense of a medication and dosing instructions. It can be modeled using both a SubstanceAdministrationOrder and a SubstanceDispenseOrder related by a RelatedClinicalStatement or grouped under a GroupedClinicalStatement.
 * 
...
@XmlSeeAlso({
    CompositeSubstanceOrder.class,
    EnteralFeedingOrder.class,
    PCAOrder.class
})
