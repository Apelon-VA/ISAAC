...
/**
 * A component of a multi-component substance administration. May be an additive
 * in a composite IV.
 * 
 * <p>
 * Java class for Constituent complex type.
 * 
 * <p>
...
@XmlType(name = "Constituent", propOrder = {
    "constituentType", "substance", "dose"
})
public class Constituent extends ExtendedVmrTypeBase {
   ...
   * 
   * @return possible object is {@link Dose }
   * 
   */
  public Dose getDose() {
    return dose;
   ...
   * 
   * @param value allowed object is {@link Dose }
   * 
   */
