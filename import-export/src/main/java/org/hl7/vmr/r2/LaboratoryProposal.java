...
/**
 * A proposal for a laboratory test.
 * 
 * <p>
 * Java class for LaboratoryProposal complex type.
 * 
 * <p>
 ...
 * 
 * <pre>
 * &lt;complexType name="LaboratoryProposal">
 *   &lt;complexContent>
...
@XmlType(name = "LaboratoryProposal", propOrder = {
    "specialHandling", "specimen", "suspectedPathogen"
})
public class LaboratoryProposal extends ProcedureProposal {
   ...
   * for the specialHandling property.
   * 
   * <p>
   ...
   * Therefore any modification you make to the returned list will be present
   * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
   * for the suspectedPathogen property.
   * 
   * <p>
   * For example, to add a new item, do as follows:
   * 
