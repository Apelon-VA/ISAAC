...
/**
 * Proposal for a substance administration. Used, for example, when a CDS system
 * proposes that a medication or vaccination be given.
 * 
 * <p>
 * Java class for SubstanceAdministrationProposal complex type.
 * 
 * <p>
...
@XmlType(name = "SubstanceAdministrationProposal", propOrder = {
    "proposedAdministrationTimeInterval", "numberFillsAllowed", "prnReason",
    "urgency", "validAdministrationTimeInterval", "proposalEventTime",
    "originationMode"
})
@XmlSeeAlso({
    PCAProposal.class, EnteralFeedingProposal.class,
    CompositeSubstanceProposal.class
})
public class SubstanceAdministrationProposal extends
