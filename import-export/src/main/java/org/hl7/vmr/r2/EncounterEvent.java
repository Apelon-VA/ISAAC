...
/**
 * EncounterEvent is the record of an interaction between an EvaluatedPerson and
 * the healthcare system. It can be used to group observations and interventions
 * performed during that interaction, through the use of
 * relatedClinicalStatements.
 * 
 * <p>
 * Java class for EncounterEvent complex type.
 * 
 * <p>
