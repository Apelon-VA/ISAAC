...
/**
 * A physical thing, group of physical things or an organization. It is a
 * concrete class that can be used as is or specialized as needed.
 * 
 * <p>
...
@XmlType(name = "Entity", propOrder = {
    "templateId", "id", "description", "type", "evaluatedPersonId",
    "attribute", "relatedEntity"
})
@XmlSeeAlso({
    AdministrableSubstance.class, Facility.class, Person.class,
    Organization.class, Device.class, Specimen.class
})
public class Entity {
