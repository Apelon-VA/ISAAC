...
/**
 * An assertion regarding a clinical condition of the subject that needs to be
 * treated or managed.
 * 
 * <p>
 * Java class for AbstractCondition complex type.
 * 
 * <p>
...
@XmlType(name = "AbstractCondition", propOrder = {
    "ageAtOnset", "certainty", "conditionStatus", "contributedToDeath",
    "wasCauseOfDeath", "criticality", "severity"
})
@XmlSeeAlso({
    AllergyOrIntolerance.class, Problem.class
})
public abstract class AbstractCondition extends ConditionBase {
