 ...
 * 
 * <p>Java class for ExtendedVmrTypeBase complex type.
 * 
...
@XmlSeeAlso({
    Qualification.class,
    DoseRestriction.class,
    TextureModification.class,
    Cycle.class,
    StringNameValuePair.class,
    Schedule.class,
    BodySite.class,
    Constituent.class,
    Dose.class,
    Value.class,
    CycleEventTiming.class,
    NutrientModification.class,
    Documentation.class,
    MotionManagement.class,
    RadiotherapySimulation.class,
    LocalizationMethod.class,
    VaccinationProtocol.class,
    NameValuePair.class
})
