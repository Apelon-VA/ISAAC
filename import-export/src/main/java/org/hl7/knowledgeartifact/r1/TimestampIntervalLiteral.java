...
/**
 * The TimestampIntervalLiteral expression returns a value of type IVL_TS with
 * the given attributes.
 * 
 * <p>
 * Java class for TimestampIntervalLiteral complex type.
 * 
 * <p>
 ...
 * 
 * <pre>
 * &lt;complexType name="TimestampIntervalLiteral">
 *   &lt;complexContent>
 *     &lt;extension base="{urn:hl7-org:knowledgeartifact:r1}Expression">
 *       &lt;sequence>
 *         &lt;element name="low" type="{urn:hl7-org:cdsdt:r2}TS" minOccurs="0"/>
 *         &lt;element name="high" type="{urn:hl7-org:cdsdt:r2}TS" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "TimestampIntervalLiteral", propOrder = {
    "low", "high"
})
public class TimestampIntervalLiteral extends Expression {
