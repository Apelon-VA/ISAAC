...
/**
 * The OverlapsAfter operator returns true if the first interval overlaps and
 * ends after the second. In other words, if the starting point of the first
 * interval contains the ending point of the second interval.
 * 
...
public class OverlapsAfter extends BinaryExpression {
