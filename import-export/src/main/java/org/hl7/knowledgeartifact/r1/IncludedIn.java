...
/**
 * The IncludedIn operator returns true if the first operand is completely
 ...
 * 
 * For the List, List overload, this operator returns true if every element in
 * the first list is included in the second list.
 * 
 * For the Interval, Interval overload, this operator returns true if the
 * beginning point of the first interval is greater than or equal to the
 * beginning point of the second interval, and the ending point of the first
...
public class IncludedIn extends BinaryExpression {
