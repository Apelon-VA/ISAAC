...
/**
 * The PeriodLiteral expression returns a value of type PIVL_TS with the given
 * attributes.
 * 
 * <p>
 * Java class for PeriodLiteral complex type.
 * 
 * <p>
...
@XmlType(name = "PeriodLiteral", propOrder = {
    "phase", "period", "frequency", "count"
})
public class PeriodLiteral extends Expression {
   ...
   * 
   * @return possible object is {@link CalendarCycle }
   * 
   */
   ...
   * 
   * @param value allowed object is {@link CalendarCycle }
   * 
   */
