...
/**
 * The Before operator returns true if the first interval ends before the second
 * one starts. In other words, if the ending point of the first interval is less
 * than the starting point of the second interval.
 * 
...
@XmlType(name = "Before")
public class Before extends BinaryExpression {
