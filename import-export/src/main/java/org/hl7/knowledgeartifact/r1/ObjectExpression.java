...
/**
 * The ObjectExpression type allows objects of any type to be built up as an
 * expression. The objectType attribute specifies the type of the object being
 * built, and the list of property elements specify the values for the
 * properties of the object. Note that the value of a property may be any
 * expression, including another ObjectExpression.
 * 
 * <p>
 * Java class for ObjectExpression complex type.
 * 
 * <p>
