 ...
 * together in a single expression, rather than having to nest multiple
 * Conditional operators. In addition, the comparand operand provides a variant
 * on the case that allows a single value to be compared in each conditional.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="comparand" type="{urn:hl7-org:knowledgeartifact:r1}Expression" minOccurs="0"/>
 *         &lt;element name="caseItem" type="{urn:hl7-org:knowledgeartifact:r1}CaseItem" maxOccurs="unbounded"/>
 *         &lt;element name="else" type="{urn:hl7-org:knowledgeartifact:r1}Expression"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Case extends Expression {
   ...
   * 
   * <p>
   * Objects of the following type(s) are allowed in the list {@link CaseItem }
   * 
   * 
   */
