...
/**
 * The NaryExpression type defines an abstract base class for an expression that
 * takes any number of arguments, including zero.
 * 
 * <p>
 * Java class for NaryExpression complex type.
 * 
 * <p>
 ...
 *       &lt;sequence>
 *         &lt;element name="operand" type="{urn:hl7-org:knowledgeartifact:r1}Expression" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlSeeAlso({
    Coalesce.class, Union.class, Intersect.class, Or.class, And.class,
    Concat.class
})
