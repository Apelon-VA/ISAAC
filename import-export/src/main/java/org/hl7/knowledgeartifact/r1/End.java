 ...
 * 
 * If the ending of the interval is open, this operator returns the Predecessor
 * of the defined ending point of the interval.
 * 
 * If the ending of the interval is closed, this operator returns the defined
 * ending point of the interval if it is not null.
 * 
...
@XmlType(name = "End")
public class End extends UnaryExpression {
