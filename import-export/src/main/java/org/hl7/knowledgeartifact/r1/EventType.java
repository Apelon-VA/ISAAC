...
public enum EventType {
   ...
   * Expression is expected to be an ExpressionRef that references an
   * ExpressionDef in ExternalData that contains a Request with a triggerType
   * attribute specified.
   * 
   * 
   */
  ...
  /**
   * A time-based event which occurs at the specified period. Expression is
   * expected to be a Period literal expression specifying the period on which
