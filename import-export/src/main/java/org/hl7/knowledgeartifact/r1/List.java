 ...
 * of evaluating the arguments to the List selector, in order. The static type
 * of the first argument determines the type of the resulting list, and each
 * subsequent argument must be of that same type.
 * 
