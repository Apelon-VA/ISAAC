 ...
 *       &lt;sequence>
 *         &lt;element name="low" type="{urn:hl7-org:cdsdt:r2}REAL" minOccurs="0"/>
 *         &lt;element name="high" type="{urn:hl7-org:cdsdt:r2}REAL" minOccurs="0"/>
 *       &lt;/sequence>
...
public class IVLREAL extends IVL {
   ...
   * 
   * @return possible object is {@link REAL }
   * 
   */
  public REAL getLow() {
    return low;
   ...
   * 
   * @param value allowed object is {@link REAL }
   * 
   */
