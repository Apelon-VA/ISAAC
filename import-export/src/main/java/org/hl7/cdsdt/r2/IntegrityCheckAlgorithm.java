...
public enum IntegrityCheckAlgorithm {
  ...
  /**
   * Secure Hash Algorithm - 1 : This algorithm is defined in FIPS PUB 180-1:
   * Secure Hash Standard. As of April 17, 1995
   * 
   */
  @XmlEnumValue("SHA1")
  SHA_1("SHA1"),
  ...
  /**
   * Secure Hash Algorithm - 256 : This algorithm is defined in FIPS PUB 180-2:
