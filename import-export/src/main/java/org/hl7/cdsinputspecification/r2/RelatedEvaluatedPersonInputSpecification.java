...
/**
 * The data required for evaluated persons related to the patient. Is a
 * specialization of the EvaluatedPersonInputSpecification class. Includes a
 * specification of the scope of evaluated persons that are required.
 * 
 * <p>
 * Java class for RelatedEvaluatedPersonInputSpecification complex type.
 * 
 * <p>
...
@XmlType(name = "RelatedEvaluatedPersonInputSpecification", propOrder = {
    "inclusionScope", "inclusionScopeChainDepth", "inclusionScopeDistance"
})
public class RelatedEvaluatedPersonInputSpecification extends
    EvaluatedPersonInputSpecification {
