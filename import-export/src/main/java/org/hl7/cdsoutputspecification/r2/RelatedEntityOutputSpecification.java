...
/**
 * Specifies the entities related to the source clinical statement regarding the
 * evaluated person of interest.
 * 
 * <p>
 * Java class for RelatedEntityOutputSpecification complex type.
 * 
 * <p>
...
public class RelatedEntityOutputSpecification {
   ...
   * Therefore any modification you make to the returned list will be present
   * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
   * for the entityOutputSpecification property.
   * 
   * <p>
   * For example, to add a new item, do as follows:
   * 
