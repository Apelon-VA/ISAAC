...
/**
 * Title: I_Constants Description: Declared all the constants used by routines
...
public class I_Constants {
  ...
  /** The Time format. */
  public static String TimeFormat = "yyyyMMdd"; // 20100305 Per SC no TZ only
                                                // YMD
  ...
  public final static String SNOMED_REFSET_UID =
      "675f8dbb-9c76-3cd2-a567-83aab81ee4da";

  /** The Constant CTV3_REFSET_ID. */
  public final static String CTV3_REFSET_ID = "900000000000497000";

  /** The Constant CTV3_REFSET_UID. */
  public final static String CTV3_REFSET_UID =
      "c134524d-aa26-3444-b316-f0d29c487d57";
  ...
  public final static String CONCEPT_INACTIVATION_REFSET_ID =
      "900000000000489007";

  /** The Constant CONCEPT_INACTIVATION_REFSET_UID. */
  public final static String CONCEPT_INACTIVATION_REFSET_UID =
      "a959e36c-39a3-3ec6-8a0b-9a4ee564348b";

  /** The Constant DESCRIPTION_INACTIVATION_REFSET_ID. */
  public final static String DESCRIPTION_INACTIVATION_REFSET_ID =
      "900000000000490003";

  /** The Constant DESCRIPTION_INACTIVATION_REFSET_UID. */
  public final static String DESCRIPTION_INACTIVATION_REFSET_UID =
      "d40e6d5c-6a93-34ab-b6e1-11f24e350380";
  ...
  public final static String REFINIBILITY_REFSET_UID =
      "b0a14b91-038f-31e6-a556-38a1714d3667";
  ...
  public final static String MAY_BE_REFSET_UID =
      "2cb0d803-0aa8-3c4a-a58c-949fa85a5016";
  ...
  public final static String MOVED_FROM_REFSET_UID =
      "34a2171a-af64-3ab2-b27d-e19914f058e3";
  ...
  public final static String MOVED_TO_REFSET_UID =
      "53e5f8b2-2f4b-3268-8a5e-04f30c241c89";
  ...
  public final static String REPLACED_BY_REFSET_UID =
      "9cb37094-2be5-3b05-a586-73ae6727e9c2";
  ...
  public final static String SAME_AS_REFSET_UID =
      "58d18fcb-02fd-3c2d-82e6-0ff2593d9df4";

  /** The Constant WAS_A_REFSET_ID. */
  public final static String WAS_A_REFSET_ID = "900000000000528000";

  /** The Constant WAS_A_REFSET_UID. */
  public final static String WAS_A_REFSET_UID =
      "0c4a8933-bf14-39b9-a743-a5dc07faa7bb";

  /** The Constant SNOMED_CORE_PATH_UID. */
  public final static String SNOMED_CORE_PATH_UID =
      "8c230474-9f11-30ce-9cad-185a96fd03a2";

  /** The Constant SNOMED_META_PATH_UID. */
  public final static String SNOMED_META_PATH_UID =
      "a60bd881-9010-3260-9653-0c85716b4391";

  /** The Constant SNOMED_INFERRED_PATH_UID. */
  public final static String SNOMED_INFERRED_PATH_UID =
      "5e51196f-903e-5dd4-8b3e-658f7e0a4fe6";

  /** The Constant SNOMED_STATED_PATH_UID. */
  public final static String SNOMED_STATED_PATH_UID =
      "8a2d3b5e-56eb-58e1-8050-f80810306a6c";

  /** The Constant SNOROCKET_AUTHOR_UID. */
  public final static String SNOROCKET_AUTHOR_UID =
      "7e87cc5b-e85f-3860-99eb-7a44f2b9e6f9";

  /** The Constant USER_AUTHOR_UID. */
  public final static String USER_AUTHOR_UID =
  ...
  public final static String US_LANG_REFSET_UID =
      "bca0a686-3516-3daf-8fcf-fe396d13cfad";

  /** The Constant USLANG_REFSET_UID_TERM_AUX. */
  public final static String USLANG_REFSET_UID_TERM_AUX =
      "29bf812c-7a77-595d-8b12-ea37c473a5e6";
  ...
  public final static String GB_LANG_REFSET_UID =
      "eb9a5e42-3cba-356d-b623-3ed472e20b30";

  /** The Constant GBLANG_REFSET_UID_TERM_AUX. */
  public final static String GBLANG_REFSET_UID_TERM_AUX =
      "a0982f18-ec51-56d2-a8b1-6ff8964813dd";
  ...
  public final static String NON_HUMAN_REFSET_UID_TERM_AUX =
      "b1b1e773-3eb6-3bcc-a6c7-52ac5d0a53be";
  ...
  public final static String VTM_REFSET_UID_TERM_AUX =
      "1a090a21-28c4-3a87-9d04-766f04600494";
  ...
  public final static String VMP_REFSET_UID_TERM_AUX =
      "c259d808-8011-3772-bece-b4fbde18d375";
  ...
  public final static String ICDO_REFSET_UID_TERM_AUX =
      "5ef10e09-8f16-398e-99b5-55cff5bd820a";
  ...
  public final static String ALTERNATIVE_REFERENCES_REFSET_ID =
      "900000000000530003";

  /** The Constant ALTERNATIVE_REFERENCES_REFSET_UID. */
  public final static String ALTERNATIVE_REFERENCES_REFSET_UID =
      "e116d83a-4402-3f4e-9628-6edafcd98ed7";

  /** The Constant ALTERNATIVE_REFERENCES_REFSET_UID_TERM_AUX. */
  public final static String ALTERNATIVE_REFERENCES_REFSET_UID_TERM_AUX =
      "e0674a75-74b3-5a6b-8db4-7c464f7aeaa0";
  ...
  public final static String REFERS_REFERENCES_REFSET_UID =
      "d15fde65-ed52-3a73-926b-8981e9743ee9";

  /** The Constant REFERS_REFERENCES_REFSET_UID_TERM_AUX. */
  public final static String REFERS_REFERENCES_REFSET_UID_TERM_AUX =
      "1b122b8f-172f-53d5-a2e2-eb1161737c2a";

  /** The Constant REPLACED_REFERENCES_REFSET_ID. */
  public final static String REPLACED_REFERENCES_REFSET_ID =
      "900000000000526001";

  /** The Constant REPLACED_REFERENCES_REFSET_UID. */
  public final static String REPLACED_REFERENCES_REFSET_UID =
      "9cb37094-2be5-3b05-a586-73ae6727e9c2";

  /** The Constant REPLACED_REFERENCES_REFSET_UID_TERM_AUX. */
  public final static String REPLACED_REFERENCES_REFSET_UID_TERM_AUX =
      "32429976-257c-5013-82ee-599404b55cc6";

  /** The Constant DUPLICATE_REFERENCES_REFSET_ID. */
  public final static String DUPLICATE_REFERENCES_REFSET_ID =
      "900000000000527005"; // 900000000000527005 , 900000000000523009

  /** The Constant DUPLICATE_REFERENCES_REFSET_UID. */
  public final static String DUPLICATE_REFERENCES_REFSET_UID =
      "58d18fcb-02fd-3c2d-82e6-0ff2593d9df4";

  /** The Constant DUPLICATE_REFERENCES_REFSET_UID_TERM_AUX. */
  public final static String DUPLICATE_REFERENCES_REFSET_UID_TERM_AUX =
      "3bb41291-ade6-5dcc-bca4-ec511722b4e3";

  /** The Constant POSSIBLY_EQUIVALENT_REFERENCES_REFSET_ID. */
  public final static String POSSIBLY_EQUIVALENT_REFERENCES_REFSET_ID =
      "900000000000523009";

  /** The Constant POSSIBLY_EQUIVALENT_REFERENCES_REFSET_UID. */
  public final static String POSSIBLY_EQUIVALENT_REFERENCES_REFSET_UID =
      "2cb0d803-0aa8-3c4a-a58c-949fa85a5016";
  ...
  public final static String MOVED_FROM_REFERENCES_REFSET_ID =
      "900000000000525002";

  /** The Constant MOVED_FROM_REFERENCES_REFSET_UID. */
  public final static String MOVED_FROM_REFERENCES_REFSET_UID =
      "34a2171a-af64-3ab2-b27d-e19914f058e3";

  /** The Constant MOVED_FROM_REFERENCES_REFSET_UID_TERM_AUX. */
  public final static String MOVED_FROM_REFERENCES_REFSET_UID_TERM_AUX =
      "bb787b5b-ff66-578c-a40f-39122d3538d6";

  /** The Constant MOVED_TO_REFERENCES_REFSET_ID. */
  public final static String MOVED_TO_REFERENCES_REFSET_ID =
      "900000000000524003";

  /** The Constant MOVED_TO_REFERENCES_REFSET_UID. */
  public final static String MOVED_TO_REFERENCES_REFSET_UID =
      "53e5f8b2-2f4b-3268-8a5e-04f30c241c89";

  /** The Constant MOVED_TO_REFERENCES_REFSET_UID_TERM_AUX. */
  public final static String MOVED_TO_REFERENCES_REFSET_UID_TERM_AUX =
      "1b4857c9-ab2b-58b1-b477-2edaf7188c85";

  /** The Constant SIMILAR_REFERENCES_REFSET_ID. */
  public final static String SIMILAR_REFERENCES_REFSET_ID =
      "900000000000529008";

  /** The Constant SIMILAR_REFERENCES_REFSET_UID. */
  public final static String SIMILAR_REFERENCES_REFSET_UID =
      "ac70d14f-dd81-312a-b123-559d43bb44d6";

  /** The Constant SIMILAR_REFERENCES_REFSET_UID_TERM_AUX. */
  public final static String SIMILAR_REFERENCES_REFSET_UID_TERM_AUX =
      "d4e52f40-7fd9-5b3f-b45b-fb9f414d0290";
  ...
  public final static String WAS_A_REFERENCES_REFSET_UID =
      "0c4a8933-bf14-39b9-a743-a5dc07faa7bb";
  ...
  public static final String CONCEPT_SNAPSHOT_FILES =
      "concept_snapshot_files.file";

  /**  The Constant RELATIONSHIP_SNAPSHOT_FILES. */
  public static final String RELATIONSHIP_SNAPSHOT_FILES =
      "relationship_snapshot_files.file";

  /**  The Constant EQUIVALENT_CONCEPTS_OUTPUT_FILE. */
  public static final String EQUIVALENT_CONCEPTS_OUTPUT_FILE =
      "equivalent_concept_output_file";

  /**  The Constant DETECTED_CYCLE_OUTPUT_FILE. */
  public static final String DETECTED_CYCLE_OUTPUT_FILE =
      "detected_cycles_output_file";
  ...
  public static final String PREVIOUS_INFERRED_RELATIONSHIP_FILES =
      "previous_inferred_relationship_snapshot_files.file";

  /**  The Constant INFERRED_RELATIONSHIPS_OUTPUT_FILE. */
  public static final String INFERRED_RELATIONSHIPS_OUTPUT_FILE =
      "inferred_relationships_output_file";
